...
#define PIP_VOFFSET2_PERCENTAGE 0.145
...
- (void)drawCorners
{
    ...
    UIFont *cornerFont = [UIFont systemFontOfSize:self.bounds.size.width * CARD_CORNER_LABEL_RATIO];
    
    NSAttributedString *cornerText = [[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@"%@\n%@", [self rankAsString], self.suit]
                                                                   attributes:@{ NSParagraphStyleAttributeName : paragraphStyle, NSFontAttributeName : cornerFont}];
    
    CGRect textBounds;
    textBounds.origin = CGPointMake(CARD_CORNER_LABEL_OFFSET, CARD_CORNER_LABEL_OFFSET);
